...
async def advantage_spoll_choker(bot, query):
    ...
    await query.answer('Checking For Movie in My Film Database...')
        ...
        if chat_type == "private":
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('What are you doing')
            else:
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Check your privat messeges. I will sent to you...', show_alert=True)
        except UserIsBlocked:
            await query.answer('Unblock me bro !', show_alert=True)
        ...
        await query.answer('What are you doing')
